...
import { sendOTP, verifyOTP, loginScript, admin, user, seller, transporterRole, logout, forgotPasswordSentOtp, forgotPasswordVerifyOtp,waitApproval } from "../controllers/authController.js";
...
router.get("/wait-approval", waitApproval);
